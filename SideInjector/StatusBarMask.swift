...
/// 现在前端取 **0.50**（看得出糊了，但很轻），后端淡出到 0，下边界与背景无差。
///
...
struct StatusBarMask: View {
    ...
    var body: some View {
        ...
        //   0 ~ 0.58    0.50        —— 状态栏文字所在区间：看得出糊了，但很轻；
        //   0.58 ~ 0.84  0.50 → 0.22 —— 过渡；
        //   0.84 ~ 1.00  0.22 → 0    —— 与背景融为一体，下边界看不出来。
        // 这是唯一的强度旋钮。参考档位（顶端 / 中点 / 过渡 / 底）：
        //   更实：0.85 / 0.85 / 0.38 / 0     更淡：0.35 / 0.30 / 0.15 / 0
        .mask {
            LinearGradient(
                stops: [
